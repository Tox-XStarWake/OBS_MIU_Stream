...
LeftKeyLight.Open("PUT", "http://192.168.1.8:9123/elgato/lights", 0)
RightKeyLight.Open("PUT", "http://192.168.1.9:9123/elgato/lights", 0)
...
REMOVE_DIS_ITEM(_DIS_RND_NUM) {
    global
    FileRead, _DIS_LIST, %_TTL_DIS_RemFileFull%
    Loop, Parse, _DIS_LIST, `n
    {
